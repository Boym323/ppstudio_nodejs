  ...
  return (
    <Dialog.Portal>
      ...
      <Dialog.Content
        ref={ref}
        className={cn(
          "z-[90] flex !max-h-[min(88dvh,calc(100dvh-env(safe-area-inset-top)-env(safe-area-inset-bottom)))] !w-full !max-w-none !translate-x-0 !translate-y-0 flex-col overflow-y-auto overscroll-contain bg-[#111015] shadow-[0_-16px_40px_rgba(0,0,0,0.35)] motion-reduce:animate-none sm:!top-auto sm:!bottom-0 sm:!max-h-[min(88dvh,calc(100dvh-env(safe-area-inset-top)-env(safe-area-inset-bottom)))] sm:!w-full sm:!translate-y-0",
          isLeft
