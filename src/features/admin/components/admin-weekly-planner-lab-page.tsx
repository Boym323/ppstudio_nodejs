...
export async function AdminWeeklyPlannerLabPage({ area, week, day, routeBase = "/admin/volne-terminy/lab" }: { area: AdminArea; week?: string; day?: string; routeBase?: string }) {
