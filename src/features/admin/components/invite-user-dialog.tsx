...
function SubmitButton({ mode }: { mode: "invite" | "edit" }) {
  ...
  return (
    <button
      type="submit"
      disabled={pending}
      className="min-w-36 rounded-full bg-[var(--color-accent)] px-4 py-2.5 text-sm font-semibold text-white transition hover:brightness-105 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--color-accent)] disabled:cursor-not-allowed disabled:opacity-60"
    >
