...
export function EmailButton({ href, label, variant = "primary" }: { href: string; label: string; variant?: "primary" | "secondary" }) {
  return <Button href={href} style={variant === "secondary" ? secondaryStyle : primaryStyle}>{label}</Button>;
}
