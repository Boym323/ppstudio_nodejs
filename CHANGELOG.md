...
- Klientské booking e-maily pro potvrzení, připomenutí, přesun, storno a odmítnutí nyní generují HTML přes React Email při zachování plain-textu, akčních URL a ICS příloh.
