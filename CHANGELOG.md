...
- Změna e-mailu klientky už neztratí neodeslaný 24h reminder: starý reminder se systémově přeskočí, queued flag se podle pozice rezervace resetuje a po enqueue window vznikne atomický replacement na aktuální snapshot; při odstranění e-mailu se nový klientský reminder nevytvoří.
