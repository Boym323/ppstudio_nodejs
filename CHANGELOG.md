...
- Release skript nyní do výstupu zapisuje i délku jednotlivých kroků přípravy, buildu, migrace a aktivace, aby bylo možné rychle určit pomalou část nasazení.
