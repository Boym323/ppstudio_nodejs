...
- Admin detail rezervace má panel `Úhrada`: nahoře read-only ukazuje cenu služby, uhrazeno voucherem, zbývá doplatit a stav `Neuhrazeno / Částečně uhrazeno / Uhrazeno`. Sekce `Dárkový poukaz` dál řeší intended voucher, ruční zadání kódu a historii čerpání. Jakmile je na rezervaci jeden voucher skutečně uplatněný nebo doplatek vychází na nulu, další voucher se v UI nenabízí.
