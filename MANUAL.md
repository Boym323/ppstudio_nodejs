...
- Formular `Poslat e-mailem` predvyplni prijemce z `purchaserEmail` (pokud existuje), predmet `Darkovy poukaz PP Studio` a kratkou zpravu. Obsluha muze hodnoty upravit pred odeslanim.
