...
Aktuální verze: <!-- current-version -->**3.22.10**. README slouží jako rychlý GitHub rozcestník a onboarding. Detailní provozní a vývojová dokumentace je vedená přímo v repozitáři, ne jako primární GitHub Wiki.
...
- `npm run dev:webpack` spustí pomalejší Webpack režim jako fallback při potížích s Turbopack HMR
