...
- `CRM souhrn` v admin detailu klientky nepřidává žádnou novou knihovnu; používá existující Prisma read model, `VoucherRedemption`, `BookingPayment` a sdílený TypeScript helper `getBookingPaymentSummary(...)`.
