...
Sem patří krátké záznamy architektonických rozhodnutí.

## Pravidla
- Jeden soubor = jedno rozhodnutí.
- Název: `NNNN-kratky-nazev.md` (např. `0001-volba-auth-provideru.md`).
- Každé ADR má stav: `navrženo`, `schváleno`, `nahrazeno`.
...
## Aktuální záznamy
- `0002-project-foundation.md`
- `0003-booking-schema-v1.md`
- `0004-public-web-information-architecture.md`
- `0005-public-booking-flow-v1.md`
- `0006-booking-submission-hardening.md`
- `0007-admin-role-aware-ia.md`
- `0008-email-delivery-and-public-cancellation-v1.md`
- `0009-admin-booking-detail-workflow-v1.md`
- `0010-admin-slot-crud-workflow-v1.md`
- `0011-admin-weekly-slot-planning-v1.md`
