...
- Booking funnel eventy se volají pouze v client handlerech a `Rezervace / Vytvořena` až po úspěšném návratu server action, chráněný refem proti duplicitnímu odeslání.
